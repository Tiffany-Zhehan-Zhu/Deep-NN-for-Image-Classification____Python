...
# Create helper functions that will initialize the parameters for our models.
...
# 
# Use the helper functions that have been implemented previously to build an $L$-layer neural network with the following structure: *[LINEAR -> RELU]$\times$(L-1) -> LINEAR -> SIGMOID*. 
